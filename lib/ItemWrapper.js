...
function (_PureComponent) {
  _inherits(ItemWrapper, _PureComponent);

  function ItemWrapper() {
    _classCallCheck(this, ItemWrapper);

    return _possibleConstructorReturn(this, (ItemWrapper.__proto__ || Object.getPrototypeOf(ItemWrapper)).apply(this, arguments));
  }
